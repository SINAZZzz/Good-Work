...
export default function ContractExtensionItem(props) {
  return (
    <div className="sm:px-7">
      <div
        className="lg:w-[400px] sm:w-full cursor-pointer sm:h-[148px] lg:h-[186px] sm:mt-4 lg:mt-7 
      shadow-Requests rounded-[13px] font-YekanBakhF bg-white border-solid border-[#D3D4D06] border-[1px]"
      >
